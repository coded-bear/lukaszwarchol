  ...
  <StyledNavigation ref={ref}>
    ...
    <nav>
      <ul>
        ...
        <NavElem to={`/${lang}/about-me/`} text={t.nav.about} closeMenu={closeMenu} />
        <NavElem to={`/${lang}/services/`} text={t.nav.services} closeMenu={closeMenu} />
        <NavElem to={`/${lang}/projects/`} text={t.nav.projects} closeMenu={closeMenu} />
        <NavElem to={`/${lang}/contact/`} text={t.nav.contact} closeMenu={closeMenu} />
      </ul>
    </nav>
